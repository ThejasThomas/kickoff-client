...
import TurfLocationPicker from "@/components/turfOwner/TurfDetails/map-location-picker";
...
const RetryEditTurfPage: React.FC<EditTurfPageProps> = ({
  turf,
  onSubmit,
  onCancel,
  isUpdating = false,
...
export default RetryEditTurfPage;