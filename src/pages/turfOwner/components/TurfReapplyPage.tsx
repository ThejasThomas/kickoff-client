    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto p-6">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
          <div>
            <h1 className="text-3xl font-bold text-gray-900 mb-2">My Rejected Turfs</h1>
            <p className="text-gray-600">Manage your rejected turf listings</p>
          </div>
          <button 
            ...
            <div className="flex-1">
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="Search rejected turfs by name, location..."
...
export default TurfReApplyPage;