...
import { Menu, X, LayoutDashboard, Users, UserCheck, Shield } from "lucide-react";
          ...
          >
            <div className="p-6">
              <div className="flex items-center justify-center mb-8">
                <h1 className="text-2xl font-bold text-orange-400" style={{color: '#f69938'}}>
                  AdminPanel
                </h1>
              </div>
              <nav>
                  ...
                  {sidebarItems.map((item, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        >
                          <IconComponent 
                            className={`w-5 h-5 mr-3 ${isActive ? "text-black" : "text-gray-400"}`} 
                          />
