...
import type {
  ...
  RevenuePeriod,
} from "@/types/adminDashboard_type";
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-8">
        ...
        <OverviewCard
          ...
          stats={[
            {
              label: "Approved",
              value: data.turfs.approved,
              color: "text-green-400",
            },
            {
              label: "Pending",
              value: data.turfs.pending,
              color: "text-yellow-400",
            },
            {
              label: "Rejected",
              value: data.turfs.rejected,
              color: "text-red-400",
            },
          ]}
        />
        ...
        <OverviewCard
          ...
          stats={[
            ...
            {
              label: "Blocked",
              value: data.owners.blocked,
              color: "text-red-400",
            },
            {
              label: "Pending",
              value: data.owners.pending,
              color: "text-yellow-400",
            },
          ]}
        />
        ...
        <div className="bg-gradient-to-br from-slate-900 to-slate-800 p-6 rounded-2xl border border-slate-700 shadow-2xl">
          ...
          <div className="mb-6">
            ...
            <p className="text-4xl font-bold text-green-400">
              ₹ {data.revenue.totalBalance.toLocaleString("en-IN")}
            </p>
          </div>
